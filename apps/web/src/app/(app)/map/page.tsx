...
const SOURCES: Record<string, string> = {
  ...
  "charlotte":     "CMPD Incidents (City of Charlotte Open Data, ArcGIS MapServer), geocoded to recognizable named neighborhoods; neighborhood boundaries © OpenStreetMap contributors (ODbL), with CMPD patrol division as a fallback.",
  ...
  "milwaukee":     "Milwaukee Police WIBR Crime Data (data.milwaukee.gov, CKAN datastore). Per-incident boolean offense flags mapped to NIBRS PERSONS/PROPERTY; incidents placed in their Department of City Development neighborhood by block-rounded coordinate.",
