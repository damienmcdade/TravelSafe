...
export default function NeighborhoodPage() {
  ...
  return (
    <main className="space-y-8">
      <header className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-slate2-500 max-w-2xl">
            Zoom in on a single San Diego neighborhood. Real SDPD incidents, what neighbors are saying, and the headlines —
            in one focused view.
          </p>
        </div>
        <LiveActivityBadge />
      ...
      <LocationSearch current={area} onResolved={setArea} placeholder="Search neighborhood, ZIP, or landmark" />
