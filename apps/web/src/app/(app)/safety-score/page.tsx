    ...
    <main className="space-y-6">
      <header className="page-hero">
        ...
        <p className="mt-2 text-slate2-700 max-w-2xl">
          Defaults to a citywide score against the FBI Crime Data Explorer 2025 national rate. Drill into a specific {city.label} neighborhood below if you want a per-area comparison, or use Compare to put two neighborhoods side-by-side.
        </p>
      </header>
