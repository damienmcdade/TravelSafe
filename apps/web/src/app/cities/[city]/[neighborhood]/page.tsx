    ...
    "@graph": [
      {
        ...
        description: `Recent police-feed safety data for ${area.label} in ${city.label}, compared to the FBI Crime Data Explorer ${score?.source.publishedYear ?? 2025} national average.`,
        containedInPlace: {
          "@type": "Place",
          name: city.label,
