...
export const metadata: Metadata = {
  title: "Terms",
  description:
    "TravelSafe terms of use — what the app is, what it isn't, acceptable use, AI assistant disclaimer, and how community posts are moderated.",
};
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-10 space-y-6">
      ...
      <section className="surface p-6 space-y-3 text-sm text-slate2-700 leading-relaxed">
        ...
        <p>TravelSafe is a neighborhood-level safety-awareness tool that surfaces publicly published police-incident data for 30 supported US cities, compared to the FBI Crime in the Nation national average. It is informational and educational.</p>
      </section>
      ...
      <section className="surface p-6 space-y-3 text-sm text-slate2-700 leading-relaxed">
        ...
        <p>The optional AI Assistant uses a third-party large language model to answer questions about TravelSafe&apos;s data. By using it you acknowledge that:</p>
        <ul className="list-disc pl-5 space-y-1">
