...
export const CITIES: CityInfo[] = [
  ...
  { slug: "tucson",        label: "Tucson",        state: "AZ", stateLabel: "Arizona",        defaultArea: "tuc-downtown",       centroid: { lat: 32.22, lng: -110.93 }, status: "live",        source: "TPD Incidents (Last 45 Days) · gis.tucsonaz.gov (ArcGIS)" },
