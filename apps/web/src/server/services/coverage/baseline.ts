...
export const COVERAGE_BASELINE: Record<string, BaselineEntry> = {
  ...
  "rochester":        { neighborhoodCount:  47, source: "Rochester Police Department Part I Crime (City of Rochester ArcGIS) — named neighborhoods (point-in-polygon)" },
  "raleigh":          { neighborhoodCount:  18, source: "Raleigh Police Department Incidents (City of Raleigh ArcGIS Open Data) — Citizen Advisory Council areas (point-in-polygon)" },
  "grand-rapids":     { neighborhoodCount:  39, source: "Grand Rapids Police Department Incidents (City of Grand Rapids ArcGIS) — named neighborhoods (point-in-polygon)" },
  "riverside":        { neighborhoodCount:  28, source: "Riverside Police Department Crimes (City of Riverside ArcGIS) — official communities" },
  "salt-lake-city":   { neighborhoodCount:  37, source: "Salt Lake City Police crime (City of SLC ArcGIS) — community councils" },
