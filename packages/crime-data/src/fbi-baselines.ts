// AUTO-GENERATED (regenerate via tools/build-city-fbi-baselines.mjs)
...
// collapse to grade E.
//
// Lives in @travelsafe/crime-data so both apps/web (Vercel routes)
// and apps/api (Railway routes) consume the same baselines without
// drift.
